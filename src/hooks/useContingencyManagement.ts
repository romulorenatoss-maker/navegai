...
export function useContingencyManagement(filters: ContingencyFilters = {}) {
  ...
  // SLA-expired contingencies stay as em_andamento and show in "Vencidas" tab via client-side filter.
  // No auto-resolve — the executor must explicitly resolve or the validador must act.
