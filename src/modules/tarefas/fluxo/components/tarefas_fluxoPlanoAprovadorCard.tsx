...
export function FluxoPlanoAprovadorCard({
  plano,
  podeResponder,
  onResponder,
  slaPadraoHoras,
      ...
      <div className="px-3 py-2 space-y-2 bg-card">
        ...
        <div className="flex flex-wrap gap-1.5 max-w-full">
          ...
          {plano.prazo_resolucao && (
            <span className="text-[10px] px-2 py-0.5 rounded-full inline-flex items-center gap-1 max-w-full whitespace-normal break-words bg-blue-50 text-blue-800">
              <Clock className="h-3 w-3" />
