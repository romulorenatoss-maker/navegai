...
| Tarefas | `operational_assignments`, `operational_templates`, `operational_template_fields`, `operational_template_sections`, `operational_field_answers`, `operational_assignment_history`, `operational_contingencies` | Tarefas | Execucao operacional |
