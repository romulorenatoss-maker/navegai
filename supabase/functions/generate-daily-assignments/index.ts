    ...
    for (const t of templates || []) {
      ...
      const snapshot = {
        ...
        responsaveis: {
          ...
          auditor_profile_id: t.auditor_profile_id || null,
          auditor_setor_id: t.auditor_setor_id || null,
      ...
      const { error: insErr } = await supabase
        ...
        .insert({
          ...
          auditor_id: t.auditor_profile_id || null,
          ...
          setor_auditor_id: t.auditor_setor_id || null,
