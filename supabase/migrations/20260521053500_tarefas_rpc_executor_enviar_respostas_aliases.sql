-- ============================================================================
-- TAREFAS - QUALIFICAR ALIASES NA RPC DE ENVIO R0
-- Data: 2026-05-21
...
--
-- Causa:
--   A funcao retorna TABLE (assignment_id uuid, ...), criando variavel de
--   saida chamada assignment_id. Referencias sem alias dentro de queries
--   contra operational_field_answers podem ficar ambiguas.
-- ============================================================================
...
BEGIN
  ...
  SELECT COUNT(*)
    ...
    FROM public.operational_field_answers ofa
...
COMMENT ON FUNCTION public.tarefas_rpc_executor_enviar_respostas IS
  'Salva R0 uma unica vez e muda status para aguardando_aprovacao. Overwrite bloqueado; aliases qualificados para evitar ambiguidade.';
